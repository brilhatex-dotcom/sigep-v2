...
import DiariasClient from "@/components/DiariasClient";

export const dynamic = "force-dynamic";

/* Área de DIÁRIAS: Ficha de Cadastro de Credor e Ficha de Controle Individual
   de Diárias, escolhidas por aba. */
