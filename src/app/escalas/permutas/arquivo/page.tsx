  ...
  return (
    <AppShell userName={session.user.name ?? ""} perfil={session.user.perfil}>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mb-4 text-sm text-apagado">Todas as permutas — da sede e das localidades — organizadas por lugar. Escolha o lugar, busque por policial/data, abra na tela e baixe em PDF ou Word.</p>
