  ...
  return (
    <div className="relative hidden flex-1 md:block md:max-w-xs">
      ...
      <input
        ...
        className="w-full rounded-lg border border-white/10 bg-campo py-2 pl-9 pr-3 text-sm text-white placeholder-apagado outline-none transition focus:border-ouro/50"
      />
    </div>
  );
}
